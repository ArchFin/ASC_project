...
for subject in subjects:
    ...
    for session in subj_sessions:
        ...
        print(f"Processing: {session_str}")
        ...
        if psd_results is not None:
            ...
            df_psd['session'] = session_str
            df_psd['run'] = session_str
            ...
            print(f"Processing failed for {subject} session {session_str}")
...
if results_list:
    ...
    output_path = '/Users/a_fin/Desktop/Year 4/Project/Data/med_psd_metrics_combined.xlsx'
