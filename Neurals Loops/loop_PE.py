...
for subject in subjects:
    ...
    for session in subj_sessions:
        ...
        if pe_results is not None:
            ...
            df_pe['session'] = session_str  # keep explicit
            df_pe['run'] = session_str       # optional: keep 'run' for compatibility
            
            df_gaps['subject'] = subject
            df_gaps['session'] = session_str
            df_gaps['run'] = session_str
            ...
            print(f"Processing permutation entropy failed for {subject} session {session_str}")
...
if results_list:
    ...
    output_path = f'/Users/a_fin/Desktop/Year 4/Project/Data/med_pe_metrics_combined_{tau}.xlsx'
