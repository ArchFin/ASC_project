...
def classify_transition(row):
    ...
    elif from_state == 1 and to_state == 3:
        if duration < time_short:
            return "Short 1→3"
        else:
            return "Long 1→3"
    
    elif from_state == 3 and to_state == 1:
        if duration < time_short:
            return "Short 3→1"
        else:
            return "Long 3→1"
    ...
    elif from_state == 3 and to_state == 2:
        if duration < time_short:
            return "Short 3→2"
        else:
            return "Long 3→2"
...
plt.tight_layout()
plt.savefig('/Users/a_fin/Desktop/Year 4/Project/Data/Interpretation/plot_count_adjusted.png')
...
plt.tight_layout()
plt.savefig('/Users/a_fin/Desktop/Year 4/Project/Data/Interpretation/heatmap_adjusted.png')
...
plt.tight_layout()
plt.savefig('/Users/a_fin/Desktop/Year 4/Project/Data/Interpretation/condition_boxplots_adjusted.png')
...
plt.tight_layout()
plt.savefig('/Users/a_fin/Desktop/Year 4/Project/Data/Interpretation/temporal_patterns_adjusted.png')
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig('/Users/a_fin/Desktop/Year 4/Project/Data/Interpretation/clustered_barchart_adjusted.png')
...
plt.tight_layout()
plt.savefig('/Users/a_fin/Desktop/Year 4/Project/Data/Interpretation/pairplot_adjusted.png')
...
plt.tight_layout()
plt.savefig('/Users/a_fin/Desktop/Year 4/Project/Data/Interpretation/small_multiples_adjusted.png')
...
plt.tight_layout()
plt.savefig('/Users/a_fin/Desktop/Year 4/Project/Data/Interpretation/duration_comparison_adjusted.png')
...
plt.tight_layout()
plt.savefig('/Users/a_fin/Desktop/Year 4/Project/Data/Interpretation/condition_period_type_adjusted.png')
...
plt.tight_layout()
plt.savefig('/Users/a_fin/Desktop/Year 4/Project/Data/Interpretation/radar_chart_adjusted.png')
...
plt.tight_layout()
plt.savefig('/Users/a_fin/Desktop/Year 4/Project/Data/Interpretation/temporal_distribution_adjusted.png')
